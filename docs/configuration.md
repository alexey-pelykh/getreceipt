...
| **`amazon.com`** | **declared and live-validated** — its page structure + cookie/auth model exercised end to end against a real account via the owned-profile browser tier ([#270](https://github.com/alexey-pelykh/getreceipt/issues/270); attended validation, 2026-07); the synthetic fixtures remain the CI proof.                                                                  |
| **`amazon.de`**  | **declared and live-validated** — page structure + cookie/auth model exercised end to end against a real `.de` account via the live e2e conformance harness (3 real 2025 receipts collected, rendered, and date-resolved; [#230](https://github.com/alexey-pelykh/getreceipt/issues/230), attended validation, 2026-07); the synthetic fixtures remain the CI proof. |
