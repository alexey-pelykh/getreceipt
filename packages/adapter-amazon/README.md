...
| **`amazon.com`** | **declared and live-validated** — page structure + cookie/auth model exercised end to end against a real account via the owned-profile browser tier ([#270](https://github.com/alexey-pelykh/getreceipt/issues/270); attended validation, 2026-07); the synthetic fixtures remain the CI proof.                                                                      |
